...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216038689.png)



## 1.1 Discrete Infers Discrete
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216036819.png)



## 1.2 Continuous Infers Continuous 
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216042990.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216041673.png)



## 1.3 Continuous Infers Discrete
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216044298.png)
> 比如$X=0,1$,$Y=X+W,W\sim N(0,1)$
> $X$是我们发送的潜在的位信号，$Y$是观测到的模糊信号，我们要去推断哪个位信号是最可能的。
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216044697.png)
> 假设先验的$X$的`PMF`是：$f_X(x)=\begin{cases}\frac{1}{2},x=0\\ \frac{1}{2},x=1\end{cases}$
> 并且假设我现在观测到了一个$y$:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216049756.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216042109.png)
...
## 2.1 离散变量⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216046159.png)

**图解**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216043661.png)

## 2.2 连续变量⭐⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216051623.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216052117.png)
> 给定一个$X,Y$之间的映射，则蓝色的部分和橙色的部分的概率值是相同的。

**算例1**⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216057190.png)
**注意这个公式仅仅对**$Y\in [0,8]$**成立**，也就是说$f_Y(y)=\begin{cases} \frac{1}{6y^{\frac{2}{3}}},y\in [0,8]\\0,otherwise\end{cases}$
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216056918.png)
**算例2**⭐⭐⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216058142.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216057802.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216056849.png)
...
## 2.3 线性函数⭐⭐⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216059640.png)

**算例1(Geometric Procedure)**⭐⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216059261.png)
...
## 2.4 单调递增函数的衍生概率⭐⭐⭐⭐⭐
> 对于$Y=g(X)$这个严格单调的函数:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216055268.png)
> 我们会有如下的关系:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216065638.png)
> 下面我们以一个简单的例子给出推导过程
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216061737.png)
...
:::success
**如果函数是严格单调递减呢?**
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216065251.png)
...
### 算例2 均匀分布的衍生变量
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216066531.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216061056.png)


### 算例3 指数分布的衍生变量
#### 指数分布的平方
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216061880.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216061528.png)


#### 独立指数分布的和
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216067314.png)
:::



### 算例4 高斯分布的衍生变量1
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216067582.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216066908.png)


### 算例4 高斯分布的衍生变量2
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216075378.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216078077.png)



## 2.7 直观解释⭐⭐⭐⭐⭐
> 对于一个这样的函数映射：
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216074743.png)我们如何直观的给出$f_Y(y)$的概率密度函数呢?
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216071370.png)
> 最终我们会得到类似的$f_Y(y)$函数图像:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216075361.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216072757.png)
> 1. 求$Z$的`CDF`表达式：$P(Z\leq z)=P(\frac{Y}{X}\leq z)$
> 2. 分情况讨论：
>    1. $0\leq z\leq 1$时, 我们有![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216072194.png), 此时我们有$\int_{0}^1\int_{0}^{xz} dydx=\frac{z}{2}$
>    2. $z>1$时，我们有![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216088401.png), 此时我们有$1-\int_0^1\int_0^{\frac{y}{z}}dxdy=1-\frac{1}{2z}$
> 3. 画出$F_Z(z)=\begin{cases} 0,z<0\\ \frac{z}{2},0\leq z\leq 1\\ 1-\frac{1}{2z},z>1\end{cases}$的图像：
> 
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216083008.png)
> 4. 画出$f_Z(z)=\begin{cases}0,z<0\\\frac{1}{4}z^2,0\leq z\leq 1 \\z-\frac{1}{2}ln(z),z>1\end{cases}$的图像:
> 
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216082063.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216088729.png)
> **求解过程:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216081095.png), 这里$x\in\{0,1,2,3\}$
> **求解思路:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216098681.png)
...
### 3.1.2  连续卷积⭐⭐⭐⭐⭐
> **给定下列离散二元函数映射， 我们要求**$p_W(w)$
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216094758.png), 
> **求解过程:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216093377.png)
...
### 3.1.3 卷积的推导
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216095324.png)


### 3.1.4 推广 - CLT
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216096283.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216102918.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216105054.png)

**Graphics - Repeated Convolution**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216106445.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216108993.png)


## 3.2 独立随机变量的差
> 如果$Z=X-Y$, 乍一看我们似乎无法使用卷积公式，但是实际上我们只要将$-Y$看成$+(-Y)$, 然后继续使用卷积公式即可。

> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216108190.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216108507.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216105114.png)



## 3.3 图解卷积计算过程
> 假设我们有两个独立的连续型随机变量$X,Y$, 其概率密度函数分别是$f_X(x)$和$f_Y(y)$, 则对于$Z=X+Y$, 我们有:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216102994.png)
> **下面我们给出直观计算卷积的几个步骤：**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216111299.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216113059.png)
...
## 3.5 常用卷积公式总结
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216116909.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216116984.png)
...
**Proof**
1. $Cov(aX+b,cY+d)\newline=E[(aX+b-E[aX+b])(cY+d-E[cY+d])]\newline=E[(aX-aE[X]+b-E[b])(cY-cE[Y])+d-E[d])]\newline=E[(aX-aE[X])(cY-cE[Y])]\newline=E[ac(X-E[X](Y-E[Y]))]\newline=acE[(X-E[X](Y-E[Y]))]\newline=acCov(X,Y)$
2. $Cov(X_1+X_2,Y)\newline=E[(X_1+X_2-E[X_1+X_2])(Y-E[Y])]\newline=E[(X_1-E[X_1]+X_2-E[X_2])(Y-E[Y])]\newline=E[(X_1-E[X_1])(Y-E[Y])+(X_2-E[X_2])(Y-E[Y])]\newline=E[(X_1-E[X_1](Y-E[Y]))]+E[(X_2-E[X_2](Y-E[Y]))]\newline=Cov(X_1,Y)+Cov(X_2,Y)$
3. $Cov(X,X)=E[(X-E(X))(X-E(X))]=E[(X-E[X])^2]=Var[X]$
4. $Cov(X,Y)=E[(X-E(X))(Y-E(Y))]=E[XY-XE[Y]-E[X]Y+E[X]E[Y]]=E[XY]-E[X]E[Y]-E[X]E[Y]+E[X]E[Y]=E[XY]-E[X]E[Y]$
5. 使用性质$2$和性质$3$, 我们有$Var(X+Y)=Cov(X+Y,X+Y)=Cov(X,X)+2Cov(X,Y)+Cov(Y,Y)=Var(X)+Var(Y)+2Cov(X,Y)$
6. 如果$X$和$Y$是独立且连续的的，$f(x,y)=f_X(x)f_Y(y)$, 所以根据期望公式$Cov(X,Y)=E[(X-E[X])(Y-E[Y])]=\int\int(X-E[X])(Y-E[Y])f_X(x)f_Y(y)dxdy$
...
> 2. $X,Y$均为连续随机变量的情况:
> 
$Cov(X,Y)=\int_{c}^d\int_{a}^b f_{X,Y}(x,y)(x-E(X))(y-E(Y))dxdy\newline=\int_{c}^d\int_{a}^b f_{X,Y}(x,y)xydxdy-\int_{c}^d\int_{a}^b f_{X,Y}(x,y)xE[Y]dxdy-\int_{c}^d\int_{a}^b f_{X,Y}(x,y)E[X]ydxdy+\int_{c}^d\int_{a}^b f_{X,Y}(x,y)E[X]E[Y]dxdy\newline=\int_{c}^d\int_{a}^b f_{X,Y}(x,y)xydxdy-\int_{c}^d f_{Y}(y)E[Y]dy-\int_{a}^b f_{X}(x)E[X]dx+E[X]E[Y]\newline=\int_{c}^d\int_{a}^b f_{X,Y}(x,y)xydxdy-E[X]E[Y]-E[X]E[Y]+E[X]E[Y]\newline=(\int_{c}^d\int_{a}^bf_{X,Y}(x,y)xydxdy)-E[X]E[Y]$



### 4.1.4 算例
#### 算例1
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216118326.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216118968.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216116386.png)

#### 算例2
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216128760.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216122533.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216128968.png)


## 4.2 相关系数
### 4.2.1 相关系数定义
> 由于协方差的单位是$X$的单位乘以$Y$的单位, 在比较协方差的时候是非常困难的， 于是我们需要对协方差的单位进行缩放，使得其单位为$1$(**无量纲的**)。
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216126877.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216123213.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216125552.png)


### 4.2.2 相关系数的性质与部分证明
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216125015.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216126450.png)

**性质3的证明**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216137644.png)


## 4.3 随机变量的和的方差⭐⭐⭐⭐⭐
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216135022.png)
:::
**推导**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216138721.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216135542.png)
...
## 4.5 总结
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216134164.png)
...
> **生产伪随机数的原理是非常非常简单的：**
> **第一步：**假设我们手头已经有一串数字，我们称它们为种子。对这些种子用递归法，“随机地(其实并不是)”生成一连串到某个自然数之间的自然数。
> **第二步**：把这些随机生成的自然数**转换成到之间的**实数 (比如通过除以来得到, 也叫归一化)。
> **第三步**：利用这串“从零到一均匀分布的随机数”，把它们**用某些算法**来**转换成其他分布的随机数**。



## 5.2 Quantile Function
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216133397.png)


## 5.3 Inverse CDF Method
> **本小节我们讨论如何从一个服从上的均匀分布的随机变量如何产生其他随机变量的方法。**
> 在详细讨论之前，我们先来看这个问题: 假设, 证明。
...
> 我们有且(不等号在的图像有`Flat`的区间时出现,读者课自行验证)。
> **因为和都是**`**Non-decreasing function**`**, 所以:**
> 
> **同时:**
> 
> 所以, 且
...
## 5.4 生成指数分布
> 上面介绍的方法被称为`Inverse CDF`法，比如我们想要生成一个指数分布的随机变量, 其`CDF`为, 我们可以先计算出 , 然后计算, 此时只要把输入改成, 经过输出的随机变量就服从一个参数为的指数分布。


## 5.5 生成泊松分布
> 由于泊松分布是一个离散分布，于是我们不能直接使用`Inverse CDF`法来通过`0-1`分布得到泊松分布的`PMF`, 但是我们可以使用黎曼和表示积分的思想来模拟。
> 假设我们要生成的泊松变量是, 我们可以从开始，顺序生成:
> 
> 此时是一个离散的函数，所以我们无法直接求导(只能使用`Generalizaed Derivative`的形式，但是这里不做深入)，所以我们只要找到那个满足:
> 
> 的最小的作为满足的, 也就是(尽管这不存在)的输出。
> 所以我们只要对每个, 都找到一个这样的, 这些就服从泊松分布。
> 另一方面, 我们有递归公式: , , , 于是我们可以得到所有的, 也就达到了模拟泊松分布的目的。
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216133331.png)

**图解**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216136004.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216149297.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216148861.png)
...
:::
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216145982.png)
:::
**示例1**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216145745.png)
**示例2**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216143706.png)



## 7.2 微积分第二定理的链式法则
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216148572.png)
:::


## 7.3 超越函数
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20230302_1216147066.png)
:::
