...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017268695.png)



## 1.1 Discrete Infers Discrete
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017266102.png)



## 1.2 Continuous Infers Continuous 
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017263146.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017268980.png)



## 1.3 Continuous Infers Discrete
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017261378.png)
> 比如$X=0,1$,$Y=X+W,W\sim N(0,1)$
> $X$是我们发送的潜在的位信号，$Y$是观测到的模糊信号，我们要去推断哪个位信号是最可能的。
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017282963.png)
> 假设先验的$X$的`PMF`是：$f_X(x)=\begin{cases}\frac{1}{2},x=0\\ \frac{1}{2},x=1\end{cases}$
> 并且假设我现在观测到了一个$y$:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017304563.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017304561.png)
...
## 2.1 离散变量⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017303251.png)

**图解**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017314927.png)

## 2.2 连续变量⭐⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017316701.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017315972.png)
> 给定一个$X,Y$之间的映射，则蓝色的部分和橙色的部分的概率值是相同的。

**算例1**⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017329125.png)
**注意这个公式仅仅对**$Y\in [0,8]$**成立**，也就是说$f_Y(y)=\begin{cases} \frac{1}{6y^{\frac{2}{3}}},y\in [0,8]\\0,otherwise\end{cases}$
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017342383.png)
**算例2**⭐⭐⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017369820.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017372479.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017384831.png)
...
## 2.3 线性函数⭐⭐⭐⭐
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017383115.png)

**算例1(Geometric Procedure)**⭐⭐⭐![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017399832.png)
...
## 2.4 单调递增函数的衍生概率⭐⭐⭐⭐⭐
> 对于$Y=g(X)$这个严格单调的函数:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017399513.png)
> 我们会有如下的关系:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017391138.png)
> 下面我们以一个简单的例子给出推导过程
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017408612.png)
...
:::success
**如果函数是严格单调递减呢?**
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017407750.png)
...
### 算例2 均匀分布的衍生变量
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017408822.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017427784.png)


### 算例3 指数分布的衍生变量
#### 指数分布的平方
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017429768.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017421374.png)


#### 独立指数分布的和
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017422806.png)
:::



### 算例4 高斯分布的衍生变量1
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017423940.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017441076.png)


### 算例4 高斯分布的衍生变量2
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017446435.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017462524.png)



## 2.7 直观解释⭐⭐⭐⭐⭐
> 对于一个这样的函数映射：
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017467773.png)我们如何直观的给出$f_Y(y)$的概率密度函数呢?
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017467824.png)
> 最终我们会得到类似的$f_Y(y)$函数图像:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017467977.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017464898.png)
> 1. 求$Z$的`CDF`表达式：$P(Z\leq z)=P(\frac{Y}{X}\leq z)$
> 2. 分情况讨论：
>    1. $0\leq z\leq 1$时, 我们有![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017465014.png), 此时我们有$\int_{0}^1\int_{0}^{xz} dydx=\frac{z}{2}$
>    2. $z>1$时，我们有![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017475114.png), 此时我们有$1-\int_0^1\int_0^{\frac{y}{z}}dxdy=1-\frac{1}{2z}$
> 3. 画出$F_Z(z)=\begin{cases} 0,z<0\\ \frac{z}{2},0\leq z\leq 1\\ 1-\frac{1}{2z},z>1\end{cases}$的图像：
> 
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017488141.png)
> 4. 画出$f_Z(z)=\begin{cases}0,z<0\\\frac{1}{4}z^2,0\leq z\leq 1 \\z-\frac{1}{2}ln(z),z>1\end{cases}$的图像:
> 
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017509300.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017519297.png)
> **求解过程:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017514417.png), 这里$x\in\{0,1,2,3\}$
> **求解思路:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017518091.png)
...
### 3.1.2  连续卷积⭐⭐⭐⭐⭐
> **给定下列离散二元函数映射， 我们要求**$p_W(w)$
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017516379.png), 
> **求解过程:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017511365.png)
...
### 3.1.4 推广 - CLT
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017515822.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017537281.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017548609.png)

**Graphics - Repeated Convolution**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017561529.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017573245.png)


## 3.2 独立随机变量的差
> 如果$Z=X-Y$, 乍一看我们似乎无法使用卷积公式，但是实际上我们只要将$-Y$看成$+(-Y)$, 然后继续使用卷积公式即可。

> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017575881.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017585705.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017587532.png)



## 3.3 图解卷积计算过程
> 假设我们有两个独立的连续型随机变量$X,Y$, 其概率密度函数分别是$f_X(x)$和$f_Y(y)$, 则对于$Z=X+Y$, 我们有:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2017585074.png)
> **下面我们给出直观计算卷积的几个步骤：**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018001028.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018001120.png)
...
## 3.5 常用卷积公式总结
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018023207.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018025531.png)
...
### 4.1.4 算例
#### 算例1
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018021479.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018041206.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018066776.png)

#### 算例2
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018063485.png)

**Key**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018083900.png)
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018094128.png)


## 4.2 相关系数
### 4.2.1 相关系数定义
> 由于协方差的单位是$X$的单位乘以$Y$的单位, 在比较协方差的时候是非常困难的， 于是我们需要对协方差的单位进行缩放，使得其单位为$1$(**无量纲的**)。
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018093120.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018098530.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018093394.png)


### 4.2.2 相关系数的性质与部分证明
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018105770.png)
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018108201.png)

**性质3的证明**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018117044.png)


## 4.3 随机变量的和的方差⭐⭐⭐⭐⭐
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018112790.png)
:::
**推导**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018118416.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018113439.png)
...
## 4.5 总结
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018129722.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018128614.png)
...
> **证明完毕。**
> **另一种证明更加简单:**
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018143243.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018148026.png)
> **第二步: **计算`CDF`的逆函数:
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018152956.png)
> **第三步: **将服从$[0,1]$均匀分布的随机变量的实现(`Data Point`)带入这个逆函数，得到的就是服从$f_w$的一个数据样本。
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018159653.png)
...
> ![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018173600.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018191759.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018214352.png)![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018231672.png)
...
:::
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018252284.png)
:::
**示例1**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018254125.png)
**示例2**![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018258976.png)



## 7.2 微积分第二定理的链式法则
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018259037.png)
:::


## 7.3 超越函数
:::info
![image.png](./衍生随机变量__贝叶斯公式变体__协方差.assets/20231011_2018277663.png)
:::
