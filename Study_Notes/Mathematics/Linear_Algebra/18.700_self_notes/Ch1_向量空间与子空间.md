...
![image.png](./Ch1_向量空间与子空间.assets/20230302_2113223322.png)

### 3.5.4 两个子空间的直和
> ![image.png](./Ch1_向量空间与子空间.assets/20230302_2113228480.png)

**Proof****矩阵视角:**
如果两个子空间的交集只有$\{0\}$, 说明两个子空间内的任意$u\in \mathbf{U},v\in \bf V$都线性无关，所以$\bf U+W$一定是`Directed Sums`

**代数视角:**
![image.png](./Ch1_向量空间与子空间.assets/20230302_2113228339.png)
