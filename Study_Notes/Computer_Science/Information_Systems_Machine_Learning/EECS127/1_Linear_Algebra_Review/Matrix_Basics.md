...
<a name="z3mYB"></a>
### Algebraic Property
> ![image.png](./Matrix_Basics.assets/20230914_1528067157.png)![image.png](./Matrix_Basics.assets/20230914_1528086932.png)

**Proof**![image.png](./Matrix_Basics.assets/20230914_1528091708.png)

<a name="J0OjP"></a>
### Geometric Property
> ![image.png](./Matrix_Basics.assets/20230914_1528111487.png)![image.png](./Matrix_Basics.assets/20230914_1528133257.png)
...
<a name="Zy6aX"></a>
## Definition
> ![image.png](./Matrix_Basics.assets/20230914_1528143758.png)![image.png](./Matrix_Basics.assets/20230914_1528431210.png)
...
### Definition
> **EECS127 HW03**
> ![image.png](./Matrix_Basics.assets/20230914_1528463297.png)

**Show that it satisfies the Matrix Form Definitions**![image.png](./Matrix_Basics.assets/20230914_1528504004.png)
...
> ![image.png](./Matrix_Basics.assets/20230914_1528531864.png)![image.png](./Matrix_Basics.assets/20230914_1528589975.png)
...
<a name="FoVVK"></a>
### Random Input
> ![image.png](./Matrix_Basics.assets/20230914_1529171164.png)![image.png](./Matrix_Basics.assets/20230914_1529197679.png)

**Solution (1)**$\mathbb{E}[\vec{y}]=\mathbb{E}[A\vec{u}]=A\mathbb{E}[\vec{u}]=\vec{0}$<br />$\mathbb{E}[\vec{y}\vec{y}^{\top}]=\mathbb{E}[A\vec{u}(A\vec{u})^{\top}]=\mathbb{E}[A\vec{u}\vec{u}^{\top}A^{\top}]=A\mathbb{E}[\vec{u}\vec{u}^{\top}]A^{\top}=AA^{\top}$
...
<a name="eimMv"></a>
### Definition
> ![image.png](./Matrix_Basics.assets/20230914_1529216218.png)
> **我们推导一些性质:**
...
> 3. $\|A\|_1=\max_{\|\vec{u}\|_1=1}\|A\vec{u}\|_1$, 其中$A\in \mathbb{R}^{m\times n}$, $\vec{u}\in \mathbb{R}^n$且$\sum_{i=1}^n |u_i|=1$, 令$\vec{a}_i\in \mathbb{R}^m$为$A$的第$i$列向量:
> 
...
> 
$\max_{\|\vec{u}\|=1}(\|A\vec{u}\|_2)^2=\max_{\|\vec{u}\|=1}\vec{u}^{\top}A^{\top}A\vec{u}=\lambda_{max}(A^{\top }A)$, 于是$\|A\|_2=\sigma_{max}(A)$。
> 5. $\|A\|_{\infty}=\max _{\|\vec{u}\|_{\infty}=1}\|A \vec{u}\|_{\infty}$其中$A\in \mathbb{R}^{m\times n}$, $\vec{u}\in \mathbb{R}^n$且$\max_{i}|u_i|=1$，令$\vec{a}_i\in \mathbb{R}^n$为$A$的第$i$行向量:
> 
...
> ![image.png](./Matrix_Basics.assets/20230914_1529226271.png)![image.png](./Matrix_Basics.assets/20230914_1529248042.png)![image.png](./Matrix_Basics.assets/20230914_1529261251.png)![image.png](./Matrix_Basics.assets/20230914_1529274317.png)

**Proof**![image.png](./Matrix_Basics.assets/20230914_1529297446.png)
...
<a name="P1xGy"></a>
## Matrix Polynomials
> ![image.png](./Matrix_Basics.assets/20230914_1529316065.png)
...
> ![image.png](./Matrix_Basics.assets/20230914_1529326886.png)

**Proof**![image.png](./Matrix_Basics.assets/20230914_1529345404.png)


<a name="IN3Ko"></a>
## Eigenshift Rule
> ![image.png](./Matrix_Basics.assets/20230914_1529354856.png)



<a name="QaCIy"></a>
## Diagonalization of Matrix Polynomials
> ![image.png](./Matrix_Basics.assets/20230914_1529361595.png)

**Proof**![image.png](./Matrix_Basics.assets/20230914_1529383383.png)


<a name="hF8Hz"></a>
## Convergence of Matrix Power(Optional)
> ![image.png](./Matrix_Basics.assets/20230914_1529407522.png)![image.png](./Matrix_Basics.assets/20230914_1529421259.png)
