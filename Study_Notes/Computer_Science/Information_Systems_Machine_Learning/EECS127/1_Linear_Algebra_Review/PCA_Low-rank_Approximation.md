<a name="v0aNH"></a>
# Overview
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529446894.png)
...
<a name="W9il7"></a>
## Motivations
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529466802.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529485469.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529503825.png)



<a name="YsXYJ"></a>
## Theorem
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529522527.png)

**Proof of Theorem 4**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529548482.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529557341.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529565152.png)
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1529581489.png)


<a name="MrETf"></a>
## Principal Component
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530008169.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530021504.png)

**Geometric Interpretation**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530044684.png)
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530063001.png)
...
> 我们从一个简单的例子入手: 
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530082290.png)
> **Few Remarks:**
...
<a name="C555d"></a>
## Problem Framework
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530103054.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530118029.png)
> **Few Remarks:**
...
<a name="ajP2g"></a>
## Figure out alpha
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530138121.png)
> **方法就是使用最小二乘法:**
...
<a name="icohi"></a>
## Figure Out c
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530154831.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530177656.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530192046.png)



<a name="r52rS"></a>
## Figure Out U
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530219371.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530234157.png)



<a name="dWsuQ"></a>
## Remarks
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530251440.png)
...
<a name="aDQKk"></a>
## Data Matrix
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530271259.png)



<a name="hctpA"></a>
## Empirical Mean
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530287793.png)
...
<a name="e33PW"></a>
## Empirical Variance
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530289844.png)
...
<a name="WVAj9"></a>
## Standardized Data
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530307246.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530318530.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530332290.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530343893.png)

**Solution**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530366348.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530375031.png)
> **这里有两个特别重要的小结论:**
...
<a name="PyAU0"></a>
### Projection⭐⭐⭐⭐⭐
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530399401.png)
...
> **这里仍然假设**$X$**是一个中心化的矩阵:**
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530413298.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530439791.png)
> **我们也可以考虑如下的优化问题:**
> 我们有:
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530454271.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530477345.png)
...
<a name="kZi7H"></a>
## PCA Denoising
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530494670.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530514569.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530536373.png)

**Examples**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1530563882.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531004507.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531148106.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531189460.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531214055.png)
...
> 假设$b=0$：
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531245179.png)
...
```
**Variance of output along a random direction**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531287991.png)
```python
################################################################################
...
```
**Maximum Variance Direction - First Component**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531408138.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531448968.png)
...
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531478749.png)
...
```
**Party Red Projection Results**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531508013.png)
```python
################################################################################
...
```
**Party Blue Projection Results**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531548959.png)
...
```
**Interpretations**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531574356.png)
...
```
**Results**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1531587182.png)
**Interpretations**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532005320.png)
...
plt.show()
```
**Projection Results**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532016562.png)

<a name="n5FGy"></a>
### Obs 5: Contentious Bills
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532038520.png)
...
```
**Results**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532045618.png)


<a name="Qlrir"></a>
### Classification using top two PCA directions
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532069466.png)
...
plt.show()
```
**Prediction based on the projection**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532089653.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532091038.png)



<a name="Hrhlu"></a>
### Finding Extreme Senators
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532113506.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532123308.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532142958.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532163398.png)
...
<a name="nE8LL"></a>
## Motivation
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532189549.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532206928.png)
...
**Proof of 1**我们要证明的是$\forall rk(B)=k$, $\|A-B\|_2\geq \|A-A_k\|_2$<br />根据`Matrix - 2 Norm`(Can be generalized to Lp Norm)的定义我们有: $\|A\|_2=\max_{\vec{x}}\frac{\|A\vec{x}\|_2}{\|\vec{x}\|_2}=\max_{\|\vec{u}\|=1}\|A\vec{u}\|_2$, 所以$\|A\vec{u}\|\leq \|A\|_2~~s.t.\|\vec{u}\|=1$。<br />所以$\|A-B\|_2\geq \|(A-B)\vec{w}\|_2~~s.t.\|\vec{w}\|=1$, 和我们要证明的式子进行比较，我们需要选择一个单位向量$\vec{w}$使得$\|(A-B)\vec{w}\|_2$和$\|A-A_k\|_2$比较相近。<br />我们可以取$\vec{w}\in null(B)$, 使得$(A-B)\vec{w}=A\vec{w}-B\vec{w}=A\vec{w}$, 则$\|(A-B)\vec{w}\|_2=\|A\vec{w}\|_2$<br />对于$A\in \mathbb{R}^{m\times n}$来说，我们对其进行奇异值分解，得到$A=U\Sigma V^{\top}$, 令$V_{k+1}=\begin{bmatrix} V_{k+1}&V_{rest}\end{bmatrix}$其中$\mathcal{R}(V_{k+1})\perp \mathcal{R}(V_{rest})$且$dim(\mathcal{R}(V_{k+1}))=k+1$, 因为$rk(B)=k$, 所以$dim(\mathcal{N}(B))=n-k$。<br />所以根据`Fundamental Theorem of Linear Algebra`我们有$\mathcal{R}(V_{k+1})\cap B\neq \{0\}$, 令$\vec{w}\in \mathcal{R}(V_{k+1})\cap B$, 即$\vec{w}\in \mathcal{R}(V_{k+1})$, 令$\vec{w}=V\vec{\alpha}=\begin{bmatrix}V_{k+1}&V_{rest} \end{bmatrix}\begin{bmatrix} \alpha_1^{\top}\\\alpha_2^{\top}\end{bmatrix}$且$\|\vec{w}\|=1$，这样的$\vec{w}$一定存在。<br />因为$\|\vec{w}\|=1$, 所以$\sum_{i=1}^{k+1}\alpha_i^2=1$<br />于是$\|A\vec{w}\|_2=\|U\Sigma V^{\top}\vec{w}\|_2=\|U\Sigma V^{\top}V\vec{\alpha}\|_2=\|U\Sigma \vec{\alpha}\|_2=\|\Sigma \vec{\alpha}\|_2=\sqrt{\alpha_1^2\sigma_1^2+\cdots+\alpha_{k+1}^2\sigma_{k+1}^2}\geq \sqrt{\sigma_{k+1}^2(\sum_{i=1}^{k+1}\alpha_i^2)}=\sigma_{k+1}$<br />所以我们证明了$\|(A-B)\vec{w}\|_2\geq \sigma_{k+1}=\|A-A_k\|_2~~s.t.\|\vec{w}\|=1,\forall\vec{w}\in \mathcal{N}(B)\cap \mathcal{R}(V_{k+1})$<br />即$\|A-B\|_2\geq \|A-A_k\|_2$成立。
**Proof of 2 Using 1**我们想要$\|A-B\|_F\geq \|A-A_k\|_F$, $\forall B~~s.t.~~rk(B)=k$成立。<br />我们知道$\|A-A_k\|_F=\|\sum_{i=k+1}^n \sigma_i\vec{u}_i\vec{v}_i^{\top}\|_F=\sqrt{\sum_{i=k+1}^n\sigma_i^2(A)}$ <br />所以我们想证明$\|A-B\|_F=\sum_{i=1}^{n}\sigma_i^2(A-B)\geq  \sum_{i=k+1}^n\sigma_i^2(A)=\sum_{i=1}^{n-k} \sigma_{k+i}^2(A)$成立。<br />想要证明$\sum_{i=1}^{n}\sigma_i^2(A-B)\geq\sum_{i=1}^{n-k} \sigma_{k+i}^2(A)$, 我们可以转而先证明:$\sum_{i=1}^{n-k}\sigma_i^2(A-B)\geq\sum_{i=1}^{n-k} \sigma_{k+i}^2(A)$<br />也就可以转而先证明$\sigma_i^2(A-B)\geq\sigma_{k+i}^2(A) ~~\forall i=1,2,\cdots n-k$<br />因为$\sigma_{k+i}(A)$是$k+i$- th largest singular value of A, 所以根据`Matrix-2 Norm`的定义我们知道: $\sigma_{k+i}(A)=\|A-A_{k+i-1}\|_2$。<br />令$A-B=C$, 则$\sigma_{i}(A-B)=\sigma_i(C)=\|C-C_{i-1}\|_2$, 其中$rk(C_{i-1})=i-1$<br />因为$rk(B)=k$, 所以$\|B-B_{k}\|_2=\sigma_{k+1}(B)=0$, 于是: <br />$\begin{aligned}\sigma_{i}(A-B)=\sigma_i(C)=\|C-C_{i-1}\|_2+0&=\|C-C_{i-1}\|_2+\|B-B_k\|_2\\&\geq\|C-C_{i-1}+B-B_k\|_2\\&=\|A-C_{i-1}-B_k\|_2 \end{aligned}$<br />令$D=B_k+C_{i-1}$, 则$rk(D)\leq rk(B_k)+rk(C_{i-1})=k+i-1$<br />所以$\sigma_i(A-B)\geq\|A-D\|_2\geq\sigma_{k+i}(A)$(第二个等号在$D=A_{k+i-1}$处取到)


<a name="Peuja"></a>
### Version 2
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532214038.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532236526.png)

**Proof of Theorem 3**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532255282.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532271779.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532299121.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532314223.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532322658.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532343181.png)

<a name="uBHGz"></a>
## Examples
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532375703.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532392028.png)



<a name="oYaIS"></a>
# Equivalent Arguments of PCA
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532415739.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532429271.png)
...
<a name="h4wTk"></a>
### Projection Lemma
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532448274.png)

**Proof**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532464974.png)

<a name="VF42H"></a>
### Equivalence
**Equivalence to P1**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532474399.png)

<a name="Do1yx"></a>
## P3 <=> P2
<a name="nD5me"></a>
### Lemma
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532492379.png)



<a name="NySab"></a>
### Equivalence
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532511818.png)

**Proof**![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532523506.png)



<a name="LPGsU"></a>
## Notes on Separable Minimization
> ![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532547210.png)![image.png](./PCA_Low-rank_Approximation.assets/20230914_1532565922.png)
